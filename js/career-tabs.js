let tabContents={Overview:`
    ...
    `};function switchTab(e){var t;for(t of document.getElementsByClassName("tab-button"))t.classList.remove("active");document.querySelector(`[onclick="switchTab('${e}')"]`).classList.add("active");var a=document.getElementById("tab-content-container"),i=document.createElement("div");for(i.id=e,i.className="tab-content",i.innerHTML=tabContents[e];a.firstChild;)a.removeChild(a.firstChild);a.appendChild(i)}